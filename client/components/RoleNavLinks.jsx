...
const NAVIGATION_MAP = {
  ...
  hospital: [
    { name: 'Management',  href: '/hospital/manage',     icon: LayoutDashboard },
    { name: 'Staff List',  href: '/hospital/staff',      icon: Users           },
    { name: 'Inventory',   href: '/hospital/inventory',  icon: ClipboardList   },
    { name: 'Finance',     href: '/hospital/finance',    icon: Wallet          },
    { name: 'Settings',    href: '/settings',            icon: Settings        },
    { name: 'My Account',  href: '/settings/account',    icon: SquareUserRound },
    { name: 'Security',    href: '/settings/security',   icon: Shield          },
  ],
  ...
  solodriverpartner: [
    { name: 'My Vehicle',  href: '/partner/solo/vehicle',        icon: Truck           },
    { name: 'Earnings',    href: '/partner/solo/earnings',       icon: Wallet          },
    { name: 'Bookings',    href: '/partner/solo/bookings',       icon: ClipboardList   },
    { name: 'My Referral', href: '/my-referral',         icon: FcInvite        },
    { name: 'Settings',    href: '/settings',            icon: Settings        },
    { name: 'My Account',  href: '/settings/account',    icon: SquareUserRound },
    { name: 'Security',    href: '/settings/security',   icon: Shield          },
 ...
 customer: [
    ...
    { name: 'My Consultations', href: '/my-consultations',  icon: Stethoscope     }, // <-- Added here
  ...
  'lab_partner': [
    { name: 'Requests',   href: '/lab-partner/bookings',        icon: FlaskConical    },
    { name: 'Profile',    href: '/lab-partner/profile',         icon: UserCircle      },
    { name: 'Tests',   href: '/lab-partner/tests',        icon: ClipboardList        },
    { name: 'Settings',   href: '/settings',            icon: Settings        },
    { name: 'My Account', href: '/settings/account',    icon: SquareUserRound },
    { name: 'Security',   href: '/settings/security',   icon: Shield          },
  ],
  ...
  'care_assistant': [
    { name: 'Care',       href: '/care-assistant/care-records/active',       icon: HeartHandshake  },
    { name: 'History',    href: '/care-assistant/history',        icon: History         },
    { name: 'Schedule',   href: '/care-assistant/schedule',       icon: ClipboardList   },
    { name: 'Settings',   href: '/settings',            icon: Settings        },
    { name: 'My Account', href: '/settings/account',    icon: SquareUserRound },
    { name: 'Security',   href: '/settings/security',   icon: Shield          },
  ],
...
const NAV_SUBLABEL = {
  ...
  '/lab-partner/bookings':        'Incoming test requests',
  '/lab-partner/profile':         'Your lab information',
  '/lab-partner/tests':        'Manage test catalog',
  ...
  '/care-assistant/care-records/active':       'Active care cases',
  '/care-assistant/history':        'Past care records',
  '/care-assistant/schedule':       'Care scheduling',
  '/partner/solo/vehicle':  'Your registered vehicle',
  '/partner/solo/earnings': 'Income and daily stats',
  '/partner/solo/bookings': 'Manage your ride requests',
  '/hospital/manage': 'Hospital dashboard',
  '/hospital/staff': 'Doctor & nurse management',
  '/hospital/inventory': 'Equipment & medicine',
  '/hospital/finance': 'Revenue & payments',
};
