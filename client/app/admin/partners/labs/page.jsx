...
export default function LabManagement() {
  ...
  return (
    <>
      ...
      <div data-theme="admin" style={{ display:'flex',flexDirection:'column',height:'100vh',background:'var(--base-100,#fff)',color:'var(--base-content,#111)',fontFamily:'var(--font-family-poppins,"Poppins",system-ui,sans-serif)',overflow:'hidden' }}>
