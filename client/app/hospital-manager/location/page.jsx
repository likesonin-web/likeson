            ...
            {hours.map((d, i) => (
              <motion.div key={d.day}
                ...
                className={`flex flex-wrap items-center gap-3 p-3.5 rounded-xl border transition-all duration-200 ${
                  d.isClosed
                    ? "bg-[var(--base-200)]/50 border-[var(--base-300)] opacity-60"
                    : "bg-[var(--base-100)] border-[var(--base-300)] hover:border-[var(--primary)]/30"
                }`}>
                <span className="w-24 text-xs font-bold text-[var(--base-content)]/70 shrink-0">{d.day}</span>

                <div className="flex items-center gap-2 flex-1 min-w-0">
                  <Input type="time" className="w-32 shrink-0"
                    disabled={d.isClosed || d.is24Hours}
                    value={d.openTime}
                    onChange={e => updateDay(d.day, "openTime", e.target.value)} />
                  <span className="text-[var(--base-content)]/30 text-xs shrink-0">to</span>
                  <Input type="time" className="w-32 shrink-0"
                    disabled={d.isClosed || d.is24Hours}
                    value={d.closeTime}
                ...
                <div className="flex items-center gap-4 shrink-0">
                  <label className="flex items-center gap-1.5 cursor-pointer select-none">
                    ...
                    />
                    <span className="text-xs font-medium text-[var(--base-content)]/60">24hr</span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer select-none">
                    <Toggle
                      checked={d.isClosed}
                    ...
                    />
                    <span className="text-xs font-medium text-[var(--base-content)]/60">Closed</span>
                  </label>
                </div>
              </motion.div>
            ))}
